...
echo "Day 11:" >> out.txt
dotnet run compile examples/aoc2022/day11/day11.bonk && bun out.js >> out.txt
echo "Day 12:" >> out.txt
dotnet run compile examples/aoc2022/day12/day12.bonk && bun out.js >> out.txt
echo "Day 13:" >> out.txt
dotnet run compile examples/aoc2022/day13/day13.bonk && bun out.js >> out.txt
echo "Day 14:" >> out.txt
dotnet run compile examples/aoc2022/day14/day14.bonk && bun out.js >> out.txt
echo "Day 18:" >> out.txt
dotnet run compile examples/aoc2022/day18/day18.bonk && bun out.js >> out.txt